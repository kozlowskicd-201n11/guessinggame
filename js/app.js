...
function questionSeven() {
  ...
  for (var index = 0; index <= 5; index++) {
    if (answer7 === statesLived[0] || answer7 === statesLived[1] || answer7 === statesLived[2]){
      points++;
...
alert('This concludes the Chris Kozlowski Guessing Game!  Your final score is ' + points + ' points out of 7.  Great work!!');
